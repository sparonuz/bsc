...
EXP_FOLDER_ROOT=/gpfs/scratch/bsc32/bsc32402/BENCH_TEST/BENCH4.0

#EXEC_FOLDER=/home/bsc32/bsc32402/local/Nemo/trunk-r10610/tests/BENCH_scorep/EXP00/
EXEC_FOLDER=/home/bsc32/bsc32402/local/Nemo/trunk-r10610/tests/BENCH_fine/EXP00
...
do
  ...
  cp ${INPUT_FOLDER}/* ${EXP_FOLDER}  || exit 1
  cp ${INPUT_FOLDER}/namelist_cfg_${CONFIG}_like  ${INPUT_FOLDER}/namelist_cfg || exit 1
  cp ${INPUT_FOLDER}/namelist_ref_${CONFIG}  ${INPUT_FOLDER}/namelist_ref || exit 1
